// 原94款产品保留；2026-09-17依据《新增系列》增加制氧机、足浴盆系列。
const PRODUCTS = [
  {
    "id": 0,
    "name": "挂脖式助听器",
  ...
  },
  {
    ...
    "category": "制氧机系列",
    "price": 2380,
    "image": "assets/p94.jpg?v=20260917",
    "description": "5L款制氧机，立式机身配有顶部操作区、提手和底部脚轮，便于放置与移动。具体型号、氧浓度及流量范围请以产品说明书和门店实物为准。"
  },
  {
    "id": 95,
    "name": "静音款5L制氧机",
    "category": "制氧机系列",
    "price": 2680,
    "image": "assets/p95.jpg?v=20260917",
    "description": "静音款5L制氧机，机身顶部设有操作区和提手，底部配有脚轮。具体噪声参数、氧浓度及流量范围可到店核实。"
  },
  {
    "id": 96,
    "name": "10L制氧机",
    "category": "制氧机系列",
    "price": 5800,
    "image": "assets/p96.jpg?v=20260917",
    "description": "10L款制氧机，浅色立式机身，前上方设有显示与操作区域，底部配有脚轮。可到店了解本款的具体型号、配件及使用说明。"
  },
  {
    "id": 97,
    "name": "10L制氧机",
    "category": "制氧机系列",
    "price": 7580,
    "image": "assets/p97.jpg?v=20260917",
    "description": "10L款制氧机，采用浅色机身与深色顶部操作面板，侧面设有提手，底部配有脚轮。与5800元款为不同产品，具体配置及参数请向门店确认。"
  },
  {
    "id": 98,
    "name": "泰昌足浴盆",
    "category": "足浴盆系列",
    "price": 188,
    "image": "assets/p98.jpg?v=20260917",
    "description": "泰昌足浴盆，深色上盖搭配顶部按键操作区，双脚置入区域清晰。适合到店了解日常足浴使用方式，具体功能及容量以实物说明为准。"
  },
  {
    "id": 99,
    "name": "泰昌足浴盆",
    "category": "足浴盆系列",
    "price": 339,
    "image": "assets/p99.jpg?v=20260917",
    "description": "泰昌足浴盆，顶部设有显示与操作面板，盆内配有滚轮结构，底部带脚轮。可到店了解操作方式、清洁方法及具体功能。"
  },
  {
    "id": 100,
    "name": "泰昌足浴盆",
    "category": "足浴盆系列",
    "price": 499,
    "image": "assets/p100.jpg?v=20260917",
    "description": "泰昌足浴盆，浅色翻盖式外观，盆内设有双脚放置区域及滚轮结构。可到店比较不同价位款式，具体容量、加热与按摩功能以产品说明为准。"
  }
];
